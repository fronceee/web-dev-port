...
function Contact() {
  return (
    <div id="contact" className='min-h-fit mx-6 max-w-sm sm:max-w-full sm:h-[30em] scroll-mt-20'>
      ...
      <div className='h-[50%] flex flex-col justify-center items-center my-20'>
        ...
        <div className='flex h-14 items-center justify-center'>
          <a  href='https://github.com/fronceee' target='_blank' className="max-w-full max-h-full flex items-center justify-center w-full h-full">
          ...
          <a><img className='flex items-center justify-center w-full h-full' src='../src/assets/github-mark-white.svg' /></a>
        </div>
      </div>
    </div>
  )
